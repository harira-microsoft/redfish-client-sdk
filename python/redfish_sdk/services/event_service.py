...
class EventServiceHandle:
    ...
    async def submit_test_event_async(self, event_data: dict | None = None) -> RedfishResponse:
        ...
        headers = AuthManager.attach_auth(self._auth_state, {})
        # Build a spec-compliant default body.
        # DSP0266 requires: EventType, EventId, EventTimestamp, Severity,
        # Message, MessageId — callers can override any or all via event_data.
        ...
        body = {**default_body, **(event_data or {})}
